...
ff= readdlm("/media/abbas/Ubuntu1/MainUbu/PhD-Parma/Solvers/Phase-field-Lornenzo-extended/run/CZMs2/forces0.txt")
...
plot!(abs.(ff[:,5]),ff[:,8],name = "ABS Avg Mid plane x jump vs x force ") 
plot!(abs.(ff[:,6]),ff[:,7],name = "ABD AVG Mid plane y jump vs y force") 
