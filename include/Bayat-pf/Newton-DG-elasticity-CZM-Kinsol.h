#ifndef DG_Elasticity_CZM_KISNSOL_H
#define DG_Elasticity_CZM_KISNSOL_H
...
namespace DG_Elasticity_CZM_KISNSOL
{
  ...
  template <int dim>
  void DG_Elasticity_CZM<dim>::compute_and_factorize_jacobian(
  ...
  template <int dim>
  void DG_Elasticity_CZM<dim>::compute_residual(
    const Vector<double> &evaluation_point,
    Vector<double> &      residual)
  {
  ...
  template <int dim>
  void DG_Elasticity_CZM<dim>::solve(const Vector<double> &rhs,
                                         Vector<double> &      solution,
                                         const double /*tolerance*/)
  {
  ...
  template <int dim>
  void DG_Elasticity_CZM<dim>::set_boundary_values()
  {
    std::map<types::global_dof_index, double> boundary_values;
    VectorTools::interpolate_boundary_values(dof_handler,
                                             0,
  ...
  template <int dim>
  void DG_Elasticity_CZM<dim>::output_results(
  ...
  void DG_Elasticity_CZM<dim>::run()
  {
    ...
    set_boundary_values();
        ...
        const double target_tolerance = 1e-3 * std::pow(0.1,1);
